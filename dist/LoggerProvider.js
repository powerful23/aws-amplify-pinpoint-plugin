...
var LoggerProvider = /** @class */ (function () {
    ...
    LoggerProvider.prototype.getCategory = function () {
        return 'Analytics';
    };
    LoggerProvider.prototype.configure = function (config) {
        var conf = config ? config : {};
        this._config = Object.assign({}, this._config, conf);
        return this._config;
    };
    LoggerProvider.prototype.startSession = function (config) {
    ...
    LoggerProvider.prototype.stopSession = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    LoggerProvider.prototype.record = function (params, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
